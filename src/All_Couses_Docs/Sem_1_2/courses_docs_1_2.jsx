...
export const pdfFiles_sem_1 = [
  ...
  export const pdfFiles_sem_2 = [
    ...
    export const Reminders_sem_1 = [
        { 
          courseKey: "English_Grammar",
          availableDocsIn: {
            answerHub: false,
            podcast: false,
            test: true,
        ...
        { courseKey: "American_Civilization",
          availableDocsIn: {
            answerHub: true,
            podcast: false,
            test: true,
        ...
        { courseKey: "African_Civilization",
          availableDocsIn: {
            answerHub: false,
            podcast: false,
            test: false,
        ...
        { courseKey: "Travail_Universitaire",
          availableDocsIn: {
            answerHub: false,
            podcast: false,
            test: false,
        ...
        { courseKey: "Civilisation_Britanique",
          availableDocsIn: {
            answerHub: true,
            podcast: false,
            test: true,
        ...
        { courseKey: "Composition_En_Français",
          availableDocsIn: {
            answerHub: false,
            podcast: false,
            test: false,
    ...
    export const Reminders_sem_2 = [
      { courseKey: "Anglophone_Lit",
        availableDocsIn: {
            answerHub: true,
            podcast: false,
            test: false,
