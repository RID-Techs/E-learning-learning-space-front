...
export function Semester1Units() {
  ...
  const displayPapersHandler_Unit_8 = async () => {
    ...
    const fetchExamPapers_Unit_1 = async () => {
      ...
      try {
        ...
        .from('exam_paper')
        .select('*')
        .eq('paper_semester', 'Semester 1')
        .eq('paper_name', 'English Grammar')
    ...
    const fetchExamPapers_Unit_2 = async () => {
      ...
      try {
        ...
        .select('*')
        .eq('paper_semester', 'Semester 1')
        .eq('paper_name', 'Méthodologie du Travail Universitaire')
        .order('paper_year', { ascending: false });
    ...
    const fetchExamPapers_Unit_3 = async () => {
      ...
      try {
        ...
        .select('*')
        .eq('paper_semester', 'Semester 1')
        .eq('paper_name', 'Phonetics and Phonology')
        .order('paper_year', { ascending: false });
    ...
    const fetchExamPapers_Unit_4 = async () => {
      ...
      try {
        ...
        .select('*')
        .eq('paper_semester', 'Semester 1')
        .eq('paper_name', 'African Civilisation : Pre-colonial Period')
        .order('paper_year', { ascending: false });
      ...
      try {
        ...
        .select('*')
        .eq('paper_semester', 'Semester 1')
        .eq('paper_name', 'British Civilisation')
        .order('paper_year', { ascending: false });
    ...
    const fetchExamPapers_Unit_6 = async () => {
      ...
      try {
        ...
        .select('*')
        .eq('paper_semester', 'Semester 1')
        .eq('paper_name', 'American Civilisation')
        .order('paper_year', { ascending: false });
    ...
    const fetchExamPapers_Unit_7 = async () => {
      ...
      try {
        ...
        .select('*')
        .eq('paper_semester', 'Semester 1')
        .eq('paper_name', 'Techniques d\'Expression Écrite')
        .order('paper_year', { ascending: false });
    ...
    const fetchExamPapers_Unit_8 = async () => {
      ...
      try {
        ...
        .select('*')
        .eq('paper_semester', 'Semester 1')
        .eq('paper_name', 'Techniques de Composition en Français')
        .order('paper_year', { ascending: false });
    ...
    <div className="units-wrapper">
      <ul className="units-holder">
        ...
        <li>
          <div className="unit-info-header">
            <img src={paper} height={64} alt="paper" />
            <p>Unit : Méthodologie du Travail Universitaire</p>
          </div>
          <div className="unit-info-body">
            {
              fetchingData_2 ? (
        ...
        <li>
          <div className="unit-info-header">
            <img src={paper} height={64} alt="paper" />
            <p>Unit : Phonetics and Phonology</p>
          </div>
          <div className="unit-info-body">
            {
              fetchingData_3 ? (
        ...
        <li>
          <div className="unit-info-header">
            <img src={paper} height={64} alt="paper" />
            <p>Unit : American Civilisation</p>
          </div>
          <div className="unit-info-body">
            {
              fetchingData_6 ? (
        ...
        <li>
          <div className="unit-info-header">
            <img src={paper} height={64} alt="paper" />
            <p>Unit : Techniques d{"'"}Expression Écrite</p>
          </div>
          <div className="unit-info-body">
            {
              fetchingData_7 ? (
        ...
        <li>
          <div className="unit-info-header">
            <img src={paper} height={64} alt="paper" />
            <p>Unit : Techniques de Composition en Français</p>
          </div>
          <div className="unit-info-body">
            {
              fetchingData_8 ? (
