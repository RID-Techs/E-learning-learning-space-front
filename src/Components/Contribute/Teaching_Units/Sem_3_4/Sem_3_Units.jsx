...
export function Semester3Units() {
  ...
  const displayPapersHandler_Unit_8 = async () => {
    ...
    const fetchExamPapers_Unit_1 = async () => {
      ...
      try {
        ...
        .from('exam_paper')
        .select('*')
        .eq('paper_semester', 'Semester 3')
        .eq('paper_name', 'Roman Africain')
    ...
    const fetchExamPapers_Unit_3 = async () => {
      ...
      try {
        ...
        .select('*')
        .eq('paper_semester', 'Semester 3')
        .eq('paper_name', 'Morphologie et Syntaxe')
        .order('paper_year', { ascending: false });
    ...
    const fetchExamPapers_Unit_4 = async () => {
      ...
      try {
        ...
        .select('*')
        .eq('paper_semester', 'Semester 3')
        .eq('paper_name', 'Roman Anglais du 18è siècle')
        .order('paper_year', { ascending: false });
      ...
      try {
        ...
        .select('*')
        .eq('paper_semester', 'Semester 3')
        .eq('paper_name', 'Traduction Avancée')
        .order('paper_year', { ascending: false });
    ...
    const fetchExamPapers_Unit_6 = async () => {
      ...
      try {
        ...
        .select('*')
        .eq('paper_semester', 'Semester 3')
        .eq('paper_name', 'Théâtre Africain : Époque Coloniale')
        .order('paper_year', { ascending: false });
    ...
    const fetchExamPapers_Unit_7 = async () => {
      ...
      try {
        ...
        .select('*')
        .eq('paper_semester', 'Semester 3')
        .eq('paper_name', 'Théâtre Classique Anglais')
        .order('paper_year', { ascending: false });
    ...
    const fetchExamPapers_Unit_8 = async () => {
      ...
      try {
        ...
        .select('*')
        .eq('paper_semester', 'Semester 3')
        .eq('paper_name', 'Techniques d\'expression Écrite Avancée')
        .order('paper_year', { ascending: false });
    ...
    <div className="units-wrapper">
      <ul className="units-holder">
        ...
        <li>
          <div className="unit-info-header">
            <img src={paper} height={64} alt="paper" />
            <p>Unit : Morphologie et Syntaxe</p>
          </div>
          <div className="unit-info-body">
            {
              fetchingData_3 ? (
        ...
        <li>
          <div className="unit-info-header">
            <img src={paper} height={64} alt="paper" />
            <p>Unit : Roman Anglais du 18è siècle</p>
          </div>
          <div className="unit-info-body">
            {
              fetchingData_4 ? (
        ...
        <li>
          <div className="unit-info-header">
            <img src={paper} height={64} alt="paper" />
            <p>Unit : Théâtre Africain : Époque Coloniale</p>
          </div>
          <div className="unit-info-body">
            {
              fetchingData_6 ? (
        ...
        <li>
          <div className="unit-info-header">
            <img src={paper} height={64} alt="paper" />
            <p>Unit : Théâtre Classique Anglais</p>
          </div>
          <div className="unit-info-body">
            {
              fetchingData_7 ? (
        ...
        <li>
          <div className="unit-info-header">
            <img src={paper} height={64} alt="paper" />
            <p>Unit : Techniques d{"'"}expression Écrite Avancée</p>
          </div>
          <div className="unit-info-body">
            {
              fetchingData_8 ? (
