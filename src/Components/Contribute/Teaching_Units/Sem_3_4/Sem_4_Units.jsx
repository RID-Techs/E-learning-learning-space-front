...
export function Semester4Units() {
  ...
  const displayPapersHandler_Unit_7 = async () => {
    ...
    const fetchExamPapers_Unit_1 = async () => {
      ...
      try {
        ...
        .eq('paper_name', 'Théâtre Américain à ses Origines')
    ...
    const fetchExamPapers_Unit_2 = async () => {
      ...
      try {
        ...
        .select('*')
        .eq('paper_semester', 'Semester 4')
        .eq('paper_name', 'Civilisation Africaine : Période Coloniale et Post-coloniale')
        .order('paper_year', { ascending: false });
    ...
    const fetchExamPapers_Unit_3 = async () => {
      ...
      try {
        ...
        .select('*')
        .eq('paper_semester', 'Semester 4')
        .eq('paper_name', 'Civilisation Britannique Contemporaine')
        .order('paper_year', { ascending: false });
    ...
    const fetchExamPapers_Unit_4 = async () => {
      ...
      try {
        ...
        .select('*')
        .eq('paper_semester', 'Semester 4')
        .eq('paper_name', 'Civilisation Américaine de l\'indépendance à nos jours')
        .order('paper_year', { ascending: false });
      ...
      try {
        ...
        .select('*')
        .eq('paper_semester', 'Semester 4')
        .eq('paper_name', 'Poésie Africaine')
        .order('paper_year', { ascending: false });
    ...
    const fetchExamPapers_Unit_7 = async () => {
      ...
      try {
        ...
        .select('*')
        .eq('paper_semester', 'Semester 4')
        .eq('paper_name', 'Poésie Américaine')
        .order('paper_year', { ascending: false });
      ...
      <ul className="units-holder">
        <li>
          <div className="unit-info-header">
            ...
            <p>Unit : Théâtre Américain à ses Origines</p>
          </div>
        ...
        <li>
          <div className="unit-info-header">
            <img src={paper} height={64} alt="paper" />
            <p>Unit : Civilisation Africaine : Période Coloniale et Post-coloniale</p>
          </div>
          <div className="unit-info-body">
            {
              fetchingData_2 ? (
        ...
        <li>
          <div className="unit-info-header">
            <img src={paper} height={64} alt="paper" />
            <p>Unit : Civilisation Britannique Contemporaine</p>
          </div>
          <div className="unit-info-body">
            {
              fetchingData_3 ? (
        ...
        <li>
          <div className="unit-info-header">
            <img src={paper} height={64} alt="paper" />
            <p>Unit : Civilisation Américaine de l{"'"}indépendance à nos jours</p>
          </div>
          <div className="unit-info-body">
            {
              fetchingData_4 ? (
