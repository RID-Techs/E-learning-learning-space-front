  ...
  const displayPapersHandler_Unit_7 = async () => {
    ...
    const fetchExamPapers_Unit_1 = async () => {
      ...
      try {
        ...
        .from('exam_paper')
        .select('*')
        .eq('paper_semester', 'Semester 5')
        .eq('paper_name', 'Roman Anglais du 19è siècle')
    ...
    const fetchExamPapers_Unit_2 = async () => {
      ...
      try {
        ...
        .select('*')
        .eq('paper_semester', 'Semester 5')
        .eq('paper_name', 'Roman Moderne Américain')
        .order('paper_year', { ascending: false });
    ...
    const fetchExamPapers_Unit_3 = async () => {
      ...
      try {
        ...
        .select('*')
        .eq('paper_semester', 'Semester 5')
        .eq('paper_name', 'Littérature et Culture')
        .order('paper_year', { ascending: false });
    ...
    const fetchExamPapers_Unit_4 = async () => {
      ...
      try {
        ...
        .select('*')
        .eq('paper_semester', 'Semester 5')
        .eq('paper_name', 'Roman Post-colonial Africain')
        .order('paper_year', { ascending: false });
      ...
      try {
        ...
        .select('*')
        .eq('paper_semester', 'Semester 5')
        .eq('paper_name', 'Littérature et Environnement')
        .order('paper_year', { ascending: false });
    ...
    const fetchExamPapers_Unit_6 = async () => {
      ...
      try {
        ...
        .select('*')
        .eq('paper_semester', 'Semester 5')
        .eq('paper_name', 'Analyse du Discours')
        .order('paper_year', { ascending: false });
    ...
    const fetchExamPapers_Unit_7 = async () => {
      ...
      try {
        ...
        .select('*')
        .eq('paper_semester', 'Semester 5')
        .eq('paper_name', 'Analyse Morpho-Phonologique')
        .order('paper_year', { ascending: false });
      ...
      <ul className="units-holder">
        <li>
          <div className="unit-info-header">
            ...
            <p>Unit : Roman Anglais du 19è siècle</p>
          </div>
        ...
        <li>
          <div className="unit-info-header">
            <img src={paper} height={64} alt="paper" />
            <p>Unit : Roman Moderne Américain</p>
          </div>
          <div className="unit-info-body">
            {
              fetchingData_2 ? (
        ...
        <li>
          <div className="unit-info-header">
            <img src={paper} height={64} alt="paper" />
            <p>Unit : Littérature et Culture</p>
          </div>
          <div className="unit-info-body">
            {
              fetchingData_3 ? (
        ...
        <li>
          <div className="unit-info-header">
            <img src={paper} height={64} alt="paper" />
            <p>Unit : Roman Post-colonial Africain</p>
          </div>
          <div className="unit-info-body">
            {
              fetchingData_4 ? (
        ...
        <li>
          <div className="unit-info-header">
            <img src={paper} height={64} alt="paper" />
            <p>Unit : Littérature et Environnement</p>
          </div>
          <div className="unit-info-body">
            {
              fetchingData_5 ? (
        ...
        <li>
          <div className="unit-info-header">
            <img src={paper} height={64} alt="paper" />
            <p>Unit : Analyse Morpho-Phonologique</p>
          </div>
          <div className="unit-info-body">
            {
              fetchingData_7 ? (
