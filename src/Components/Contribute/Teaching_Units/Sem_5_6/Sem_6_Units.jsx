...
export function Semester6Units() {
  ...
  const displayPapersHandler_Unit_7 = async () => {
    ...
    const fetchExamPapers_Unit_1 = async () => {
      ...
      try {
        ...
        .from('exam_paper')
        .select('*')
        .eq('paper_semester', 'Semester 6')
        .eq('paper_name', 'Techniques de Rédaction Académique')
    ...
    const fetchExamPapers_Unit_2 = async () => {
      ...
      try {
        ...
        .select('*')
        .eq('paper_semester', 'Semester 6')
        .eq('paper_name', 'Théorie et Critique Littéraire')
        .order('paper_year', { ascending: false });
    ...
    const fetchExamPapers_Unit_3 = async () => {
      ...
      try {
        ...
        .select('*')
        .eq('paper_semester', 'Semester 6')
        .eq('paper_name', 'Littérature Comparée')
        .order('paper_year', { ascending: false });
    ...
    const fetchExamPapers_Unit_4 = async () => {
      ...
      try {
        ...
        .select('*')
        .eq('paper_semester', 'Semester 6')
        .eq('paper_name', 'Étude et Critique de la Littérature Africaine')
        .order('paper_year', { ascending: false });
      ...
      try {
        ...
        .select('*')
        .eq('paper_semester', 'Semester 6')
        .eq('paper_name', 'Étude et Critique de la Littérature Anglaise')
        .order('paper_year', { ascending: false });
    ...
    const fetchExamPapers_Unit_6 = async () => {
      ...
      try {
        ...
        .select('*')
        .eq('paper_semester', 'Semester 6')
        .eq('paper_name', 'Étude et Critique de la Littérature Américaine')
        .order('paper_year', { ascending: false });
    ...
    const fetchExamPapers_Unit_7 = async () => {
      ...
      try {
        ...
        .select('*')
        .eq('paper_semester', 'Semester 6')
        .eq('paper_name', 'Littérature et Media')
        .order('paper_year', { ascending: false });
      ...
      <ul className="units-holder">
        <li>
          <div className="unit-info-header">
            ...
            <p>Unit : Techniques de Rédaction Académique</p>
          </div>
        ...
        <li>
          <div className="unit-info-header">
            <img src={paper} height={64} alt="paper" />
            <p>Unit : Théorie et Critique Littéraire</p>
          </div>
          <div className="unit-info-body">
            {
              fetchingData_2 ? (
        ...
        <li>
          <div className="unit-info-header">
            <img src={paper} height={64} alt="paper" />
            <p>Unit : Étude et Critique de la Littérature Africaine</p>
          </div>
          <div className="unit-info-body">
            {
              fetchingData_4 ? (
        ...
        <li>
          <div className="unit-info-header">
            <img src={paper} height={64} alt="paper" />
            <p>Unit : Étude et Critique de la Littérature Anglaise</p>
          </div>
          <div className="unit-info-body">
            {
              fetchingData_5 ? (
        ...
        <li>
          <div className="unit-info-header">
            <img src={paper} height={64} alt="paper" />
            <p>Unit : Étude et Critique de la Littérature Américaine</p>
          </div>
          <div className="unit-info-body">
            {
              fetchingData_6 ? (
