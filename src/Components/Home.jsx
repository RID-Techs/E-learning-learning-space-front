...
Since :
« Since » can be translated as « depuis » in French, which indicates the starting point of an action or event.
 For example : « I have been studying French since last year » can be translated as « J’étudie le français depuis l’année dernière » in French.

For : 
« For » can be translated as « depuis » in French when indicating a duration of time.
 For example : « I have been studying French for two years » can be translated as « J’étudie le français depuis deux ans » in French.

Ago :
« Ago » can be translated as « il y a » in French when indicating a past time. 
For example : 
