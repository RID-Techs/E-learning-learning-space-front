  ...
  const Login = (e) => {
    ...
    if (username.value === "" || password.value === "") {
      ...
      const SigningIn = async () => {
        const SigningInProcess = await fetch(
          "https://e-learning-learning-space-back.onrender.com/myElearning/login",
          {
            method: "POST",
            credentials: "include",
            headers: {
      ...
      <div className="login-holder mt-4">
        <div className="inputs-wraper">
          <form>
            ...
            <div className="">
              <button onClick={Login} id="login-button" type="button">
        ...
        <div className="footer-first-part">
          <div className="header-holder">
            <header>
              ...
              <h3 className="me-4">E-learning</h3>
            </header>
          </div>
