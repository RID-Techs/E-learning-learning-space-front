...
export function American_Test () {
  ...
  return (
    <>
      ...
      <h1>⦔ Take Amercian Civilization test</h1>
      ...
      <div className="question-container mt-3">
        <div className="question-wrapper">
          <p>10--{">"} Who translated the Bible into into the Massachusetts language ?</p>
        </div>
        <div className="answer-wrapper">
          <div className="correct-answer">
      ...
      <div className="question-container mt-3">
        ...
        <div className="answer-wrapper">
          <div className="correct-answer">
            <button onClick={wrongAnswerBtn_13} className="disable-btn" type="button">American Constitution</button>
            <button onClick={rightAnswerBtn_13} className="disable-btn" type="button">Mayflower Compact</button>
          </div>
        </div>
        <div className="impression-section mt-3">
      ...
      <div className="question-container mt-3">
        ...
        <div className="answer-wrapper">
          <div className="correct-answer">
            ...
            <button onClick={rightAnswerBtn_16} className="disable-btn" type="button">the Pilgrms</button>
          </div>
        </div>
        <div className="impression-section mt-3">
      ...
      <div className="question-container mt-3">
        <div className="question-wrapper">
          <p>30--{">"} An event occured on March 5, 1770, and this event is knwn as......</p>
        </div>
        <div className="answer-wrapper">
          <div className="correct-answer">
      ...
      <div className="question-container mt-3">
        <div className="question-wrapper">
          <p>34--{">"} The General George Washington was appointed on June 15, 1775.</p>
        </div>
        <div className="answer-wrapper">
          <div className="correct-answer">
      ...
      <div className="question-container mt-3">
        ...
        <div className="answer-wrapper">
          <div className="correct-answer">
            ...
            <button onClick={rightAnswerBtn_36} className="disable-btn" type="button">Boston Tea Party</button>
          </div>
        </div>
        <div className="impression-section mt-3">
      ...
      <div className="question-container mt-3">
        ...
        <div className="answer-wrapper">
          <div className="correct-answer">
            ...
            <button onClick={rightAnswerBtn_39} className="disable-btn" type="button">Stamp Act of 1765</button>
          </div>
        </div>
        <div className="impression-section mt-3">
      ...
      <div className="question-container mt-3">
        <div className="question-wrapper">
          <p>41--{">"} The Second Continental Congress which aws presided by John Hancock took place in Pennsylvania State House (Independance Hall) on......</p>
        </div>
        <div className="answer-wrapper">
          <div className="correct-answer">
