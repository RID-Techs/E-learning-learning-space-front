...
export function Century_18thNovel_Test () {
  ...
  return (
    <>
      ...
      <h1>⦔ Take a 18<sup>th</sup> Century English Novel test</h1>
      ...
      <div className="question-container mt-3">
        ...
        <div className="answer-wrapper">
          <div className="correct-answer">
            ...
            <button onClick={rightAnswerBtn_17} className="disable-btn" type="button">The Canterbury Tales</button>
          </div>
        </div>
        <div className="impression-section mt-3">
      ...
      <div className="question-container mt-3">
        ...
        <div className="answer-wrapper">
          <div className="correct-answer">
            <button onClick={rightAnswerBtn_21} className="disable-btn fw-bold fst-italic" type="button">Don Quixote</button>
            <button onClick={wrongAnswerBtn_21} className="disable-btn fw-bold fst-italic" type="button">Oroonoko</button>
          </div>
        </div>
        <div className="impression-section mt-3">
