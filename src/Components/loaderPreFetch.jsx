...
export async function LoadHomePage () {
    ...
    const GetHomePage = async(retryCount = 0) => {
        try {
            const HomePage = await fetch("https://e-learning-learning-space-back.onrender.com/myElearning/home", {
            method: "GET",
            credentials: "include"
          })
    ...
    const GetNewToken = async() => {
        try {
          const NewToken = await fetch("https://e-learning-learning-space-back.onrender.com/myElearning/refreshtoken", {
            method: "POST",
            credentials: "include"
          })
